...
export default class Referee {
    ...
    directions = [
      ...
      getAttackResultCombat(AttackPiece: Piece, DefendPiece: Piece, AUnitConfigI: number, DUnitConfigI: number): number {
        let AttackDamage = 0;
       ...
       AttackDamage += AttackPiece.experience * 2;
       AttackDamage -= DefendPiece.experience * 2;
